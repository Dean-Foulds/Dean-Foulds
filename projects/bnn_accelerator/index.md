...
<span style="display:inline-block;background:rgba(74,222,128,0.08);color:#4ade80;border:1px solid rgba(74,222,128,0.35);border-radius:3px;padding:0.28rem 0.8rem;font-size:0.78rem;font-weight:600;letter-spacing:0.04em;margin-bottom:1rem;">✓ Selected for Fabrication — Competitive Group Submission</span>
